...
# There are 4 genes that have TRUEs in all 25 samples.
...
#### concert counts to DGEList object
```{r}
...
levels(sampleinfo$Reactor)
## Let's choose purple for basal and orange for luminal
col.cell <- c("purple","orange")[sampleinfo$Reactor]
data.frame(sampleinfo$Reactor,col.cell)
...
# reorder the data so that most abundanct is at the bottom of the graph
