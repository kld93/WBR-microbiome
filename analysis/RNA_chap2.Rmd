...
##### Adding in the anammox genes (hzsA and hzo)
## hzsA
dmnd_out_hzsA <- read_csv("data/RNA/chap2_readVrefs_hzsA.csv", 
                  col_types = "ccdiiiiiiiddc", 
                  col_names = c("query", 
                                "subject", 
                                "pid",
...
## hzo
dmnd_out_hzo <- read_csv("data/RNA/chap2_readVrefs_hzo.csv", 
                  col_types = "ccdiiiiiiiddc", 
                  col_names = c("query", 
                                "subject", 
                                "pid",
...
dmnd_hzsA <-  dmnd_out_hzsA %>%
    group_by(fn) %>%
    summarize(raw.count = n()) %>% #sums up the rows for each sample
    left_join(read_count) %>%
    mutate(norm.count = (raw.count/count) * 1000000) %>% 
    mutate(gene = "hzsA") %>% # Add column with gene name (one gene so annoation map not needed)
    filter(!fn == "blank_trim_cut")

dmnd_hzo <-  dmnd_out_hzo %>%
    group_by(fn) %>%
    summarize(raw.count = n()) %>% #sums up the rows for each sample
    left_join(read_count) %>%
    mutate(norm.count = (raw.count/count) * 1000000) %>% 
    mutate(gene = "hzo") %>% # Add column with gene name (one gene so annoation map not needed)
    filter(!fn == "blank_trim_cut")
...
## hzsA
d3_hzsA = dplyr::group_by(dmnd_hzsA, gene, Treatment, Reactor, Timepoint)

#d3_hzsA_avg = dplyr::summarize(d3_hzsA, mean = mean(norm.count), sd = sd(norm.count))

d3_hzsA_avg = dplyr::summarize(d3_hzsA, median = median(norm.count), upper_lim = max(norm.count), lower_lim = min(norm.count))

## hzo
d3_hzo = dplyr::group_by(dmnd_hzo, gene, Treatment, Reactor, Timepoint)

#d3_hzo_avg = dplyr::summarize(d3_hzo, mean = mean(norm.count), sd = sd(norm.count))

d3_hzo_avg = dplyr::summarize(d3_hzo, median = median(norm.count), upper_lim = max(norm.count), lower_lim = min(norm.count))
...
d3_N_ppk_hzsA_hzo <- rbind(d3_N_avg, d3_ppk_avg, d3_hzsA_avg, d3_hzo_avg)

d3_N_ppk_hzsA_hzo$rename = c("Nap", "Nap", "Nap", "Nap", "Nap", "Nap", "Nap", "Nap", "Nap", "Nap", "Nap", "Nap", "Nar", "Nar", "Nar", "Nar", "Nar", "Nar", "Nar", "Nar", "Nar", "Nar", "Nar", "Nar", "NirK", "NirK", "NirK", "NirK", "NirK", "NirK", "NirK", "NirK", "NirK", "NirK", "NirK", "NirK", "NirS", "NirS", "NirS", "NirS", "NirS", "NirS", "NirS", "NirS", "NirS", "NirS", "NosZ", "NosZ", "NosZ", "NosZ", "NosZ", "NosZ", "NosZ", "NosZ", "NosZ", "NosZ", "NosZ", "NosZ", "cNor", "cNor", "cNor", "cNor", "cNor", "cNor", "cNor", "qNor", "qNor", "qNor", "qNor", "qNor", "qNor", "qNor", "qNor", "qNor", "qNor", "qNor", "qNor", "ppk", "ppk", "ppk", "ppk", "ppk", "ppk", "ppk", "ppk", "ppk", "ppk", "ppk", "ppk", "hzsA", "hzsA", "hzsA", "hzsA", "hzsA", "hzsA", "hzo", "hzo", "hzo", "hzo", "hzo")

d3_N_ppk_hzsA_hzo$ord = factor(d3_N_ppk_hzsA_hzo$rename, levels=c("Nap","Nar","NirK","NirS","cNor","qNor","NosZ", "hzsA", "hzo", "ppk"))
...
d3_N_ppk_hzsA_hzo$Timepoint <- factor(d3_N_ppk_hzsA_hzo$Timepoint, levels=c('24', '120'))
