...
```{r}
dia_Ncycle.df = read_csv("C:/github/WBR-microbiome/data/Woodchip_readVrefs_N.csv", 
...
```{r}
ann.df = read_csv("C:/github/WBR-microbiome/data/annotation_map.csv", col_types = "cc", col_names = c("gene","subject"))
```

### Read in the metadata (i.e., read counts)
```{r}
count.df = read_csv("C:/github/WBR-microbiome/data/Woodchip_metadata_N.csv") %>%
  rename(fn = filename)
```
