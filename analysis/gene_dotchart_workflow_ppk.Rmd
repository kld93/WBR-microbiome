...
```{r}
dia_ppk.df = read_csv("C:/github/WBR-microbiome/data/ppk/Woodchip_readVrefs_ppk.csv", 
...
```{r}
count.df = read_csv("C:/github/WBR-microbiome/data/ppk/Woodchip_metadata_ppk.csv") %>%
  rename(fn = filename)
```
...
```{r}
tiff("ppk_presence_dotchart.tiff", width = 7.2, height = 3.4, units = 'in', res = 150)
plot(p) # Make plot
dev.off()
```
