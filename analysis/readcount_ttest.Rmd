...
## Mann-Whitney U Test
```{r}
wilcox_test(count ~ Treatment, data = readcount, alternative = "two.sided", paired = FALSE, conf.level = 0.95, exact = FALSE)
# p-value = 0.383
wilcox_test(yield ~ Treatment, data = readcount, alternative = "two.sided", paired = FALSE, conf.level = 0.95, exact = FALSE)
# p-value = 0.663
wilcox_test(mass ~ Treatment, data = readcount, alternative = "two.sided", paired = FALSE, conf.level = 0.95, exact = FALSE)
# p-value = 0.190
```
