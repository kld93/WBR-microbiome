...
Mann-Whitney U test for read count of fungi in U vs M samples:
```{r}
wilcox.test(reads ~ treatment, data = ascomycota, alternative = "two.sided", paired = FALSE, conf.level = 0.95, exact = FALSE)
```
